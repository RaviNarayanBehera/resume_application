      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            menu_list(name: 'Skills',iconname: Icons.workspace_premium_outlined),
            menu_list(name: 'Interests',iconname: Icons.interests_outlined),
            menu_list(name: 'About You',iconname: Icons.person_pin_outlined),
            menu_list(name: 'Experience',iconname: Icons.work),
  ...
  Container menu_list({required String name,required iconname}) {
    return Container(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Text('  $name ',style: TextStyle(fontWeight: FontWeight.w500,fontSize: 18,letterSpacing: 1),),
                  Spacer(),
                  Icon(iconname),
                ],
              ),
